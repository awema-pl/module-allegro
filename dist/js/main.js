(function () {
    ...
    var allegroMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'allegro', {}) );
        }
    };
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("ALLEGRO_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("allegro/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.ALLEGRO_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var allegro = normalizeComponent_1(
    ...
    var lang = {
        ALLEGRO_EXAMPLE: 'allegro example',
    };
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('allegro', allegroModule);
            AWEMA.lang = lang;
        }
    };
